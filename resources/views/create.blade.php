                    ...
                    <div class="card-header text-center">{{ __('INPUT NEW ITEM') }} </div>
                        <div class="card-body">
                            <form action="{{ route('createBook') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    <label for="Quantity" class="form-label">Stock of Item</label>
                                    <input name="Quantity" type="numeric" class="form-control" id="formGroupExampleInput" placeholder="Input Stock of Item">
                                    @error('Quantity')
                                    <div class="text-danger">
                                        {{ $message }}
                                    </div>
